      ...
      .row.flex
        .col
          q-card.q-mb-lg.bg-blue
            q-card-section
              div 📅 <strong>22-10-31</strong> - Hi, thanks for visiting! This project is still a <strong>super early prototype</strong>; it's buggy but in <a href="https://github.com/modelprompter/modelprompter">active development</a>!
                  ...
                  ul
                    ...
                    li <strong>Icons:</strong>
                      ul
                        ...
                        li <q-icon name="extension"></q-icon> - Show the blocks
