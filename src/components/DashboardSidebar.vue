  ...
  q-drawer(v-model='settings.ui.sidebar.left.open' bordered)
    q-list.q-px-md.q-pb-md.row.items-stretch
      .q-pa-xs.q-mb-md(:class='[settings.ui.sidebar.left.maximized ? "col-md-3 col-lg-2 col-xl-1 col-xs-12" : "col-12 col-xs-12"]')
        q-item-label(header)
          q-btn.bg-dark.text-white(color='light' v-if='settings.ui.sidebar.left.maximized' icon-right='west' @click='settings.ui.sidebar.left.maximized = false')
            span.q-mr-sm Collapse Dashboard
          q-btn.bg-dark.text-white(color='light' v-else icon-right='east' @click='settings.ui.sidebar.left.maximized = true')
      ...
      .q-pa-xs.col-md-9.col-lg-10.colx-11.col-xs-12(v-if='settings.ui.sidebar.left.maximized' style='margin-top: 50px')
